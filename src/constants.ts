...
export const CHAINS_MAP: Record<string, ChainInfo> = {
    "ethereum": {
        ...
        chainId: 1,
        eid: 30101,
        address: "0xbCbAE4dB3C0d7D95de39b0C3830208F42987f678",
        blocktime: 12,
    },
    "base": {
        chainKey: "base",
        chainId: 8453,
        eid: 30184,
        address: "0x6BAFAA37b51404A833d39385AA11996BeE286DbC",
        blocktime: 2,
    },
    "arbitrum": {
        chainKey: "arbitrum",
    ...
    "optimism": {
        ...
        chainId: 10,
        eid: 30111,
        address: "0x4737914b6fddc8e35B7F72F5D55713C4F9c35c38",
        blocktime: 2,
    }
};
